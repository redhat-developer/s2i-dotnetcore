            ...
            if(this.state.loading) { 
              ...
              if(this.props.currentUser.isInspector){
                return <Row id="home-summary">
                  ...
                  <h2>You have <a href={ `#/${ Constant.BUSES_PATHNAME }?${ Constant.SCHOOL_BUS_NEXT_30_DAYS_QUERY }=true` }>{this.props.currentUser.dueNextMonthInspections}</a> inspections coming due in the next month</h2>
                </Row>;
              }
            }
          })()}
