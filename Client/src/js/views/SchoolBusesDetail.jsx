...
class SchoolBusesDetail extends React.Component {
  ...
  openInspection = (props) => {
    ...
    if (props.params.inspectionId === "0") {
      ...
      inspection = {
        ...
        inspector: {
          id: props.currentUser.isInspector ? props.currentUser.id : 0,
        },
      };
  ...
  updateUIState = (state, callback) => {
    this.setState({ ui: { ...this.state.ui, ...state } }, () => {
      store.dispatch({
        type: Action.UPDATE_INSPECTIONS_UI,
        inspections: this.state.ui,
      });
      if (callback) {
        callback();
      }
  ...
  generatePermit = () => {
    ...
    Api.newSchoolBusPermit(this.props.params.schoolBusId)
      .then(() => {
            ...
            <Col md={6}>
              <Well>
                ...
                {(() => {
                  ...
                  return (
                    <div id="school-buses-data">
                      <Row>
                        <ColDisplay md={12} label="District">
                          {bus.districtName}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="Inspector">
                          {bus.inspectorName}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="Home Terminal">
                          {bus.homeTerminalAddress}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="City, Province">
                          {bus.homeTerminalCityProv}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="Postal Code">
                          {bus.homeTerminalPostalCode}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="Description">
                          {bus.homeTerminalComment}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="Permit Class">
                          {bus.permitClassCode}
                        </ColDisplay>
                      </Row>
                      <Row>
                      ...
                      <Row>
                        <ColDisplay md={12} label="Restrictions">
                          {bus.restrictionsText}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="School District">
                          {bus.schoolDistrictName}
                        </ColDisplay>
                      </Row>
                      <Row>
                      ...
                      <Row>
                        <ColDisplay md={12} label="Seating Capacity">
                          {bus.schoolBusSeatingCapacity}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="Mobile Aid Capacity">
                          {bus.mobilityAidCapacity}
                        </ColDisplay>
                      </Row>
                    </div>
                  );
            ...
            <Col md={6}>
              <Well>
                ...
                {(() => {
                  ...
                  return (
                    <div id="school-buses-icbc-owner">
                      <Row>
                        <ColDisplay md={8} label="Owner">
                          {ccw.icbcRegOwnerName}
                        </ColDisplay>
                        <ColDisplay md={4} label="Status">
                          {ccw.icbcRegOwnerStatus}
                        </ColDisplay>
                      </Row>
                      <Row>
                        ...
                        >
                          {ccw.icbcRegOwnerRODL}
                          <br />
                          {ccw.icbcRegOwnerPODL}
                        </ColDisplay>
                      </Row>
                    </div>
                  );
            ...
            <Col md={6}>
              <Well>
                ...
                {(() => {
                  ...
                  return (
                    <div id="school-buses-nsc">
                      <Row>
                        <ColDisplay md={12} label="NSC #">
                          {ccw.nscClientNum}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="Carrier Name">
                          {ccw.nscCarrierName}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="Carrier Conditions">
                          {ccw.nscCarrierConditions}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={12} label="Carrier Safety Rating">
                          {ccw.nscCarrierSafetyRating}
                        </ColDisplay>
                      </Row>
                    </div>
                  );
            ...
            <Col md={12}>
              <Well>
                ...
                {(() => {
                  ...
                  return (
                    <div id="school-buses-icbc-vehicle">
                      <Row>
                        <ColDisplay md={3} label="Year">
                          {ccw.icbcModelYear}
                        </ColDisplay>
                        <ColDisplay md={3} label="GVW">
                          {ccw.icbcGrossVehicleWeight}
                        </ColDisplay>
                        <ColDisplay md={3} label="Net Wt">
                          {ccw.icbcNetWt}
                        </ColDisplay>
                        <Col md={3}></Col>
                      </Row>
                      <Row>
                        <ColDisplay md={3} label="Vehicle Type">
                          {ccw.icbcVehicleType}
                        </ColDisplay>
                        <ColDisplay md={3} label="Make">
                          {ccw.icbcMake}
                        </ColDisplay>
                        <ColDisplay md={3} label="Model">
                          {ccw.icbcModel}
                        </ColDisplay>
                        <ColDisplay md={3} label="Colour">
                          {ccw.icbcColour}
                        </ColDisplay>
                      </Row>
                      <Row>
                        <ColDisplay md={3} label="Rate Class">
                          {ccw.icbcRateClass}
                        </ColDisplay>
                        <ColDisplay md={3} label="Body">
                          {ccw.icbcBody}
                        </ColDisplay>
                        <ColDisplay md={3} label="Fuel">
                          {ccw.icbcFuel}
                        </ColDisplay>
                        <Col md={6}></Col>
                      </Row>
                      <Row>
                        <ColDisplay md={3} label="CVIP Decal">
                          {ccw.icbccvipDecal}
                        </ColDisplay>
                        <ColDisplay md={3} label="Rebuilt Status">
                          {ccw.icbcRebuiltStatus}
                        </ColDisplay>
                        <ColDisplay md={3} label="Seating Capacity">
                          {ccw.icbcSeatingCapacity}
                        </ColDisplay>
                        <Col md={6}></Col>
                      </Row>
                      <Row>
                        <ColDisplay md={3} label="Fleet Unit #">
                          {ccw.icbcFleetUnitNo}
                        </ColDisplay>
