...
class SchoolBusesEditDialog extends React.Component {
  static propTypes = {
    ...
    schoolDistricts: PropTypes.object,
  ...
  didChange = () => {
    if (this.state.status !== this.props.schoolBus.status) {
      return true;
    }
    if (this.state.ownerId !== this.props.schoolBus.schoolBusOwner.id) {
      return true;
    }
    if (this.state.districtId !== this.props.schoolBus.district.id) {
      return true;
    }
    if (this.state.inspectorId !== this.props.schoolBus.inspector.id) {
      return true;
    }

    if (this.state.address1 !== this.props.schoolBus.homeTerminalAddress1) {
      return true;
    }
    if (this.state.address2 !== this.props.schoolBus.homeTerminalAddress2) {
      return true;
    }
    if (this.state.cityId !== this.props.schoolBus.homeTerminalCity.id) {
      return true;
    }
    if (this.state.province !== this.props.schoolBus.homeTerminalProvince) {
      return true;
    }
    if (this.state.postalCode !== this.props.schoolBus.homeTerminalPostalCode) {
      return true;
    }
    if (this.state.description !== this.props.schoolBus.homeTerminalComment) {
      return true;
    }

    if (this.state.permitClassCode !== this.props.schoolBus.permitClassCode) {
      return true;
    }
    if (this.state.bodyTypeCode !== this.props.schoolBus.bodyTypeCode) {
      return true;
    }
    if (this.state.restrictionsText !== this.props.schoolBus.restrictionsText) {
      return true;
    }
                    ...
                    <FormGroup controlId="restrictionsText">
                      <div>
                        ...
                        <span className="pull-right">
                          ...
                          >
                            <Button title="editRestrictions" bsSize="xsmall">
                      ...
                      <FormInputControl
                        componentClass="textarea"
                        rows="4"
                        value={this.state.restrictionsText}
                        updateState={this.updateState}
                        disabled={this.state.disableRestrictionsText}
                      />
                    </FormGroup>
                  </Col>
                </Row>
                  ...
                  <Col md={5}>
                    <FormGroup controlId="independentSchoolName">
                      ...
                      <FormInputControl
                        ...
                        updateState={this.updateState}
                        disabled={!this.state.isIndependentSchool}
                      />
                    </FormGroup>
                  </Col>
                </Row>
