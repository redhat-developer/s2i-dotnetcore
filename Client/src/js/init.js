...
export default function startApp() {
  ...
  userPromise.then(() => {
    ...
    var groupsPromise = Api.getGroups();

    return Promise.all([citiesPromise, districtsPromise, regionsPromise, schoolDistrictsPromise, serviceAreasPromise, groupsPromise]).then(() => {
