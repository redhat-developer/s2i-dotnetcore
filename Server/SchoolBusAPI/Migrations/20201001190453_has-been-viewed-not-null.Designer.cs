...
namespace SchoolBusAPI.Migrations
{
    ...
    [Migration("20201001190453_has-been-viewed-not-null")]
    partial class hasbeenviewednotnull
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolBusAPI.Models.CCWNotificationDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("CCWNOTIFICATION_DETAIL_ID")
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);

                    b.Property<int?>("CCWNotificationId")
                        .HasColumnName("CCWNOTIFICATION_ID")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CCWNotificationId");

                    b.ToTable("SBI_CCWNOTIFICATION_DETAIL");
                });
            ...
            modelBuilder.Entity("SchoolBusAPI.Models.CCWNotificationDetail", b =>
                {
                    b.HasOne("SchoolBusAPI.Models.CCWNotification", null)
                        .WithMany("CCWNotificationDetails")
                        .HasForeignKey("CCWNotificationId");
                });
