...
call load.bat "..\ApiSpec\TestData\userGroup\userGroup_userGroup.json" api/users/bulk "%TARGET_SERVER%"

rem needs endpoint
rem call load.bat "..\ApiSpec\TestData\users\users_user.json" api/users/bulk "%TARGET_SERVER%"

rem needs endpoint
rem call load.bat "..\ApiSpec\TestData\rolepermission\rolepermission_RP.json" api/groups/bulk %TARGET_SERVER%

rem needs endpoint
rem call load.bat "..\ApiSpec\TestData\CCW\CCW_CCW.json" api/ccwdata/bulk http://localhost:53477

rem needs endpoint
rem call load.bat "..\ApiSpec\TestData\group\group_Group.json" api/groups/bulk http://localhost:53477
