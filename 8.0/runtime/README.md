...
```
$ git clone -b dotnet-7.0 https://github.com/redhat-developer/s2i-dotnetcore-ex.git
...
```
$ s2i build bin/Release/net7.0/publish ubi8/dotnet-70-runtime s2i-dotnetcore-ex
```
...
* **DOTNET_FRAMEWORK,DOTNET_CORE_VERSION**
    ...
    These variables contain the framework (`net7.0`) and .NET version (`7.0`) respectively.
