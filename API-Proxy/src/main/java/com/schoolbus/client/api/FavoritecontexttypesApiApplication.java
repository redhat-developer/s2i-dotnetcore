...
@ApplicationPath("/api/favoritecontexttypes")

public class FavoritecontexttypesApiApplication extends Application{
	@Inject
	private FavoritecontexttypesApi _FavoritecontexttypesApi; 
	
	private static final Logger LOG = LoggerFactory.getLogger(FavoritecontexttypesApiApplication.class);
