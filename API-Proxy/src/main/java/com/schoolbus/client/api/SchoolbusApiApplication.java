...
@ApplicationPath("/api/schoolbus")

public class SchoolbusApiApplication extends Application{
	@Inject
	private SchoolbusApi _SchoolbusApi; 
	
	private static final Logger LOG = LoggerFactory.getLogger(SchoolbusApiApplication.class);
