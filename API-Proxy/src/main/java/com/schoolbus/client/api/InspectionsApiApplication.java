...
@ApplicationPath("/api/inspections")

public class InspectionsApiApplication extends Application{
	@Inject
	private InspectionsApi _InspectionsApi; 
	
	private static final Logger LOG = LoggerFactory.getLogger(InspectionsApiApplication.class);
