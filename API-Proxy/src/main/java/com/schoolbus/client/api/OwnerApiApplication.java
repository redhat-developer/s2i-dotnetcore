...
@ApplicationPath("/api/owner")

public class OwnerApiApplication extends Application{
	@Inject
	private OwnerApi _OwnerApi; 
	
	private static final Logger LOG = LoggerFactory.getLogger(OwnerApiApplication.class);
