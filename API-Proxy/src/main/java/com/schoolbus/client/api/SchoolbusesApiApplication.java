...
@ApplicationPath("/api/schoolbuses")

public class SchoolbusesApiApplication extends Application{
	@Inject
	private SchoolbusesApi _SchoolbusesApi; 
	
	private static final Logger LOG = LoggerFactory.getLogger(SchoolbusesApiApplication.class);
