...
public class SchoolBusHistory   {
   ...
   * Primary Key
   **/
  public SchoolBusHistory id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public SchoolBusHistory schoolBus(SchoolBus schoolBus) {
  ...
  public boolean equals(Object o) {
    ...
    SchoolBusHistory schoolBusHistory = (SchoolBusHistory) o;
    return Objects.equals(id, schoolBusHistory.id) &&
        Objects.equals(schoolBus, schoolBusHistory.schoolBus);
  }
