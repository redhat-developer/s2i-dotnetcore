...
public class BusNotification   {
   ...
   * Primary Key
   **/
  public BusNotification id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public BusNotification schoolBus(SchoolBus schoolBus) {
  ...
  public boolean equals(Object o) {
    ...
    BusNotification busNotification = (BusNotification) o;
    return Objects.equals(id, busNotification.id) &&
        Objects.equals(schoolBus, busNotification.schoolBus);
  }
