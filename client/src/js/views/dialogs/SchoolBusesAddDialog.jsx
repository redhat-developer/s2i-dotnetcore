...
class SchoolBusAddDialog extends React.Component {
  ...
  updateSearchState = (state) => {
    this.setState(
      ...
      () => {
        store.dispatch({
          type: Action.UPDATE_CCW_SEARCH,
          schoolBusesCCW: this.state.search,
        });
      }
    );
  };
  ...
  fetch = () => {
    if (this.state.search.keySearchParams) {
      ...
      Api.searchSchoolBuses(this.state.search.keySearchParams)
        .then(() => {
                  ...
                  return (
                    <div>
                      <Row className="has-error">
                        ...
                        >
                          <Button title="view bus" bsSize="xsmall">
                          ...
                          {(() => {
                            return (
                              <div id="school-buses-icbc-vehicle">
                                <Row>
                                  <ColDisplay md={6} label="Year">
                                    {ccw.icbcModelYear}
                                  </ColDisplay>
                                  <ColDisplay md={6} label="GVW">
                                    {ccw.icbcGrossVehicleWeight}
                                  </ColDisplay>
                                </Row>
                                <Row>
                                  <ColDisplay md={6} label="Net Wt">
                                    {ccw.icbcNetWt}
                                  </ColDisplay>
                                  <Col md={6}></Col>
                                </Row>
                                <Row>
                                  <ColDisplay md={6} label="Vehicle Type">
                                    {ccw.icbcVehicleType}
                                  </ColDisplay>
                                  <ColDisplay md={6} label="Make">
                                    {ccw.icbcMake}
                                  </ColDisplay>
                                </Row>
                                <Row>
                                  <ColDisplay md={6} label="Model">
                                    {ccw.icbcModel}
                                  </ColDisplay>
                                  <ColDisplay md={6} label="Colour">
                                    {ccw.icbcColour}
                                  </ColDisplay>
                                </Row>
                                <Row>
                                  <ColDisplay md={6} label="Rate Class">
                                    {ccw.icbcRateClass}
                                  </ColDisplay>
                                  <ColDisplay md={6} label="Body">
                                    {ccw.icbcBody}
                                  </ColDisplay>
                                </Row>
                                <Row>
                                  <ColDisplay md={6} label="Fuel">
                                    {ccw.icbcFuel}
                                  </ColDisplay>
                                  <Col md={6}></Col>
                                </Row>
                                <Row>
                                  <ColDisplay md={6} label="CVIP Decal">
                                    {ccw.icbccvipDecal}
                                  </ColDisplay>
                                  <ColDisplay md={6} label="Rebuilt Status">
                                    {ccw.icbcRebuiltStatus}
                                  </ColDisplay>
                                </Row>
                                <Row>
                                  <ColDisplay md={6} label="Seating Capacity">
                                    {ccw.icbcSeatingCapacity}
                                  </ColDisplay>
                                  <Col md={6}></Col>
                                </Row>
                                <Row>
                                  <ColDisplay md={6} label="Fleet Unit #">
                                    {ccw.icbcFleetUnitNo}
                                  </ColDisplay>
